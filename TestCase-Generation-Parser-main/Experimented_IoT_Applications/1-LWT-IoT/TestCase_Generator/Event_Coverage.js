...
const eventMappingsFilePath1 = 'Assets/esm.json'; // Update the file path accordingly
...
const deviceData = require("./Assets/deviceData.json");
...
for (let fileNum = 2; fileNum <= 5; fileNum++) {
